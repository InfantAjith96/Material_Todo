...
import com.example.materialtodo.adapters.TaskRVVBListAdapter
import com.example.materialtodo.databinding.ActivityMainBinding
import com.example.materialtodo.models.Task
import com.example.materialtodo.utils.Status
import com.example.materialtodo.utils.StatusResult
import com.example.materialtodo.utils.clearEditText
import com.example.materialtodo.utils.hideKeyBoard
import com.example.materialtodo.utils.longToastShow
import com.example.materialtodo.utils.setupDialog
import com.example.materialtodo.utils.validateEditText
import com.example.materialtodo.viewmodels.TaskViewModel
...
//        setContentView(R.layout.activity_main)
        ...
        when (timeOfDay) {
            in 0..11 -> {
                ...
                mainBinding.today.text = getString(R.string.good_morning)
            }
            in 12..15 -> {
                //Toast.makeText(this, "Good Afternoon", Toast.LENGTH_SHORT).show();
                mainBinding.today.text = getString(R.string.good_afternoon)
            }
            in 16..20 -> {
                //Toast.makeText(this, "Good Evening", Toast.LENGTH_SHORT).show();
                mainBinding.today.text = getString(R.string.good_evening)
            }
            in 21..23 -> {
                //Toast.makeText(this, "Good Night", Toast.LENGTH_SHORT).show();
                mainBinding.today.text = getString(R.string.good_night)
            }
        }
